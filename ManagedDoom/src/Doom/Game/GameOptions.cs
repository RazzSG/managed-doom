...
namespace ManagedDoom
{
    public sealed class GameOptions
    {
        ...
        private GameCompatibilityMode compatibilityMode;
        private CompatibilityDetectionSource compatibilitySource;
        ...
        public GameOptions()
        {
            ...
            compatibilityMode = GameCompatibilityMode.Auto;
            compatibilitySource = CompatibilityDetectionSource.Default;
        ...
        public GameCompatibility Compatibility
        {
            ...
            {
                compatibility = value;
                compatibilityMode = value switch
                {
                    GameCompatibility.Vanilla => GameCompatibilityMode.Vanilla,
                    GameCompatibility.Boom => GameCompatibilityMode.Boom,
                    GameCompatibility.Mbf => GameCompatibilityMode.Mbf,
                    GameCompatibility.Mbf21 => GameCompatibilityMode.Mbf21,
                    _ => throw new ArgumentOutOfRangeException(nameof(value), value, null)
                };
                compatibilitySource = CompatibilityDetectionSource.UserOverride;
            }
        }

        public GameCompatibilityMode CompatibilityMode => compatibilityMode;
        ...
        public CompatibilityDetectionResult SetCompatibility(Wad wad, GameCompatibilityMode mode)
        {
            ...
            compatibilitySource = result.Source;
