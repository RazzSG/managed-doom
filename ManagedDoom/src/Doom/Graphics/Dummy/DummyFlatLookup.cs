...
namespace ManagedDoom
{
    public sealed class DummyFlatLookup : IFlatLookup
    {
        ...
        {
            var firstFlat = wad.GetLumpNumber(DoomString.Resolve("F_START")) + 1;
            var lastFlat = wad.GetLumpNumber(DoomString.Resolve("F_END")) - 1;
            ...
            for (var lump = firstFlat; lump <= lastFlat; lump++)
            {
                ...
                var flat = name != DoomString.Resolve("F_SKY1") ? DummyData.GetFlat() : DummyData.GetSkyFlat();
