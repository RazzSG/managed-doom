    ...
    public sealed class Palette
    {
        ...
        public Palette(Wad wad)
        {
            try
            {
                ...
                data = wad.ReadLump(DoomString.Resolve("PLAYPAL"));
                baseColors = new uint[256];
                for (var i = 0; i < baseColors.Length; i++)
                {
                    ...
                    baseColors[i] = (uint)(r | (g << 8) | (b << 16) | (255 << 24));
                }
        ...
        public uint[] BaseColors => baseColors;
    }
}
