		...
		public Finale(GameOptions options)
		{
			...
			switch (options.GameMode)
			{
				...
				case GameMode.Retail:
					...
					{
						case 1:
							flat = DoomString.Resolve("FLOOR4_8");
							text = DoomInfo.Strings.E1TEXT;
							break;

						case 2:
							flat = DoomString.Resolve("SFLR6_1");
							text = DoomInfo.Strings.E2TEXT;
							break;

						case 3:
							flat = DoomString.Resolve("MFLR8_4");
							text = DoomInfo.Strings.E3TEXT;
							break;

						case 4:
							flat = DoomString.Resolve("MFLR8_3");
						...
						default:
							...
							flat = DoomString.Resolve("F_SKY1");
							text = string.Empty;
							break;
					}
					break;
				...
				case GameMode.Commercial:
					...
					{
						case 6:
							flat = DoomString.Resolve("SLIME16");
							text = c1Text;
							break;

						case 11:
							flat = DoomString.Resolve("RROCK14");
							text = c2Text;
							break;

						case 20:
							flat = DoomString.Resolve("RROCK07");
							text = c3Text;
							break;

						case 30:
							flat = DoomString.Resolve("RROCK17");
							text = c4Text;
							break;

						case 15:
							flat = DoomString.Resolve("RROCK13");
							text = c5Text;
							break;

						case 31:
							flat = DoomString.Resolve("RROCK19");
							text = c6Text;
							break;
