    ...
    public sealed class Map
    {
        ...
        public Map(GameContent resorces, World world)
            : this(
                ...
                GameCompatibilityFeatures.SupportsBoom(world.Options.Compatibility)
                    ? resorces.BoomAnimated.Animation
                    : resorces.Animation,
                world)
        {
        }
        ...
        public Map(Wad wad, ITextureLookup textures, IFlatLookup flats, TextureAnimation animation, World world)
        {
            try
            {
                ...
                boomTags = new BoomTagIndex(sectors, lines);
        ...
        private Texture GetSkyTextureByMapName(string name)
        {
            ...
            {
                var skyName = DoomString.Resolve($"SKY{episode}");
                ...
                var sky4 = DoomString.Resolve("SKY4");
                var sky1 = DoomString.Resolve("SKY1");
            ...
            if (number <= 11)
                return textures[DoomString.Resolve("SKY1")];

            if (number <= 21)
                return textures[DoomString.Resolve("SKY2")];

            return textures[DoomString.Resolve("SKY3")];
        }
        ...
        public BoomTagIndex BoomTags => boomTags;
