...
public sealed class ChoiceMenuItem(string name, int skullX, int skullY, int itemX, int itemY, string[] states, int stateX, Func<int> reset, Action<int> action) : MenuItem(skullX, skullY, null)
{
