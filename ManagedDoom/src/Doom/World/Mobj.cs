...
namespace ManagedDoom
{
    public class Mobj : Thinker
    {
        ...
        // More list: links in origin sector (if needed).
        private Mobj sectorNext;
        private Mobj sectorPrev;

        // Boom list of every sector touched by this thing's radius.
        private BoomSectorTouchNode touchingSectorList;
        ...
        public BoomSectorTouchNode TouchingSectorList
        {
            get => touchingSectorList;
            set => touchingSectorList = value;
        }
